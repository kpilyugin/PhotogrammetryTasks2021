...
// TODO: что если попробовать другой PROPAGATION_STEP?
// TODO: что если попробовать в PROPAGATION брать 8 из 20 лучших с точки зрения их cost-ов, и уже затем выбирать из них лучшего с учетом примерки на себя